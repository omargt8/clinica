...
class PatientsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'carnet' => ['type' => 'integer', 'length' => 6, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'faculty_id' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'career_id' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'town' => ['type' => 'string', 'length' => 80, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'faculty_id' => 'Lorem ipsum dolor sit amet',
            'career_id' => 'Lorem ipsum dolor sit amet',
            ...
            'money' => 1,
            'created' => '2017-06-30 19:25:08',
            'modified' => '2017-06-30 19:25:08'
        ],
    ];
}
